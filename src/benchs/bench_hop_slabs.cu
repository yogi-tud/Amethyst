...
void bench_hop_slabs(
    ...
    size_t bitmask_size)
{
    bench_elementstuffing_wrapper<hop_nogaps_launcher<true>, 64>::call(
        "hop_slabs", element_count, h_data1, h_data2, h_output, d_data1, d_data2, d_output, bitmask_size);
}
